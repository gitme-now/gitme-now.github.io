...
export const stats = [
  ...
  { value: "1M+", label: "Downloads across Xerox mobile apps" },
  { value: "6+", label: "Consecutive BLI Line of the Year awards" },
...
export const highlights = [
  ...
  {
    title: "1M+ downloads, 4+ star ratings",
    description:
      "Xerox Workplace and the Xerox Print Service Plugin scaled to over a million downloads on the Google Play Store, with a 50% surge in installs and a 40% uptick in customer ratings (4.4/5.0 stars) under my supervision.",
  ...
  },
  {
    ...
    description:
      "The Xerox Team Availability App — an emergency personnel resource tracker I designed and deployed during COVID-19 — was piloted at Imperial College Healthcare NHS Trust and covered by international press.",
    tag: "Fox Business",
    link: "https://www.foxbusiness.com/technology/xerox-app-track-remote-employees",
    linkLabel: "Read the Fox Business coverage",
  },
  {
    title: "6 consecutive BLI Line of the Year awards",
    description:
      "Xerox Workplace has consistently won Keypoint Intelligence's BLI Smart Workplace Solutions Line of the Year award, serving Fortune 500 enterprises, government agencies, and healthcare institutions worldwide.",
    tag: "Keypoint Intelligence / BLI",
    link: "https://keypointintelligence.com/view-award?region=&id=205078265119",
    linkLabel: "View the BLI award",
  },
]
    ...
    roles: [
      {
        ...
        points: [
          ...
          "Led the mobile app engineering behind Xerox Workplace, part of the solution recognized with 6 consecutive BLI Smart Workplace Solutions Line of the Year awards from Keypoint Intelligence.",
          "Designed the Xerox Team Availability App, piloted at Imperial College Healthcare NHS Trust.",
...
export const software = [
  ...
  },
  {
    ...
    metrics: ["1.1M+ downloads", "4.4/5.0 rating", "6x BLI Line of the Year", "MDM integrated"],
    links: [
      ...
      { label: "BLI Award", href: "https://keypointintelligence.com/view-award?region=&id=205078265119" },
    ],
  },
  {
    name: "Xerox Print Service Plugin",
    description:
      "Native Android print services plugin, part of the 1M+ download footprint across Xerox's mobile ecosystem.",
